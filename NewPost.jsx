...
const NewPost = ({ newPost, setNewPost }) => {
    ...
    return (
        <Dialog open={newPost} onClose={() => setNewPost(false)} maxWidth='xl'>
            <div className="flex flex-col sm:w-screen max-w-4xl card">
                    <div className="py-3 border-b px-4 flex justify-between w-full bg-surface">
                        <span className="font-medium text-theme">Create new post</span>
                        <button onClick={newPostSubmitHandler} disabled={loading} className="text-primary font-medium">Share</button>
                    </div>
                ...
                <div className="flex sm:flex-row sm:items-start items-center flex-col w-full">
                    ...
                    {postImage ?
                        <div className="bg-surface h-48 sm:h-[80vh] w-full flex items-center justify-center">
                            <img draggable="false" className="object-contain h-full w-full" src={postPreview} alt="post" />
                        </div>
                        :
                        <div onDragEnter={handleDragChange} onDragLeave={handleDragChange} className={`${dragged && 'opacity-40'} relative bg-surface h-36 sm:h-[80vh] w-full flex flex-col gap-2 items-center justify-center mx-16`}>
                    ...
                    <div className="flex flex-col border-l sm:h-[80vh] w-full bg-surface border-theme">
                        ...
                        <div className="flex gap-3 px-3 py-2 items-center">
                            ...
                            <span className="text-theme text-sm font-semibold">{user.username}</span>
                        </div>


                        <div className="p-3 w-full border-b relative border-theme">
                            ...
                            <textarea
                                className="outline-none resize-none h-32 sm:h-auto text-theme"
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <button onClick={newPostSubmitHandler} disabled={loading} className="btn-primary">Post</button>
