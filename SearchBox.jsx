    ...
    return (
        <ClickAwayListener onClickAway={handleClickAway}>
            <div className="hidden sm:flex items-center gap-3 pl-4 ml-36 w-64 py-2 bg-[#efefef] rounded-lg relative">
                ...
                {searchResult &&
                    <>
                        <div className="absolute right-1/2 -bottom-5 rotate-45 h-4 w-4 drop-shadow-lg bg-surface rounded-sm border-l border-t border-theme"></div>

                        <div className={`${loading ? 'justify-center items-center' : users.length < 1 && 'justify-center items-center'} absolute overflow-y-auto overflow-x-hidden flex flex-col top-[49px] w-[23rem] -left-11 h-80 bg-surface drop-shadow-xl rounded border-theme`}>
                            ...
                            {loading ?
                                ...
                                : users.length > 0 ?
                                    ...
                                    :
                                    <span className="text-muted-helper text-sm">No results found.</span>
                            }
