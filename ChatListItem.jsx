...
const ChatListItem = ({ _id, users, latestMessage }) => {
    ...
    return (
        <Link to={`/direct/t/${_id}/${friend._id}`} className={`${params.chatId === _id && 'bg-surface'} flex gap-3 items-center py-2 px-4 cursor-pointer hover:bg-surface`}>
            ...
            <div className="flex flex-col items-start">
                ...
                <span className="text-sm truncate w-36 text-muted-helper">{latestMessage?.content}</span>
            </div>
        </Link>
    )
}
