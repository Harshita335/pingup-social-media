    ...
    return (
        <div className="hidden sm:flex flex-col border-r w-1/4">
            ...
            {activeTab === 0 && (
                <div className="px-6 mt-4">
                    <button
                        ...
                        className="bg-primary-blue text-white px-3 py-2 rounded w-full"
                    >
                        Save
                    </button>
                </div>
            ...
            <div className="flex border-t mt-12 flex-col gap-2 p-6">
                ...
                <p className="text-xs text-gray-400">Control settings for connected experiences across Pingup, the app and Messenger, including story and post sharing and logging in.</p>
            </div>
        </div>
    )
}
